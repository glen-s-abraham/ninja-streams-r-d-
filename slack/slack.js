...
function updateUsersInRoom(namespace, roomToJoin) {
  ...
  let clientsList = io.of(namespace.endpoint).adapter.rooms.get(roomToJoin);
  let memberCount = clientsList ? clientsList.size : 0;
  io.of(namespace.endpoint).in(roomToJoin).emit("updateMembers", memberCount);
}
